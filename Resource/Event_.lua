...
--{
	--SetTime( "2015-06-08 14:23", "2015-12-08 16:11" )
	SetTime( "2015-06-09 14:23", "2015-12-10 00:00" )
	...
	SetLevelUpGift( 60, "all", "II_SYS_SYS_SCR_BX_PET_LAWOLF7", 1, 2, LEGEND_CLASS_NORMAL )
	SetLevelUpGift( 80, "all", "II_SYS_SYS_SCR_BX_PET_LAWOLF7", 1, 2, LEGEND_CLASS_MASTER )
	SetLevelUpGift( 125, "all", "II_SYS_SYS_SCR_BX_PET_LAWOLF7", 1, 2, LEGEND_CLASS_HERO )
	SetLevelUpGift( 140, "all", "II_SYS_SYS_SCR_BX_PET_LAWOLF7", 1, 2, LEGEND_CLASS_LEGEND_HERO )
...
AddEvent ( "Exp 2x" )
--{
	SetTime( "2015-06-09 14:23", "2016-12-10 00:00" )
	SetSpawn( MONSTER, "MI_MZOMBIE", 20000, 0 )
	SetExpFactor ( 1500 )
	SetLevelUpGift( 131, "all", "II_SYS_SYS_SCR_BX_PET_LAWOLF7", 1, 2, LEGEND_CLASS_LEGEND_HERO, JOB_MENTALIST_HERO )
	SetLevelUpGift( 125, "all", "II_SYS_SYS_SCR_BXRANGER_125", 1, 2, LEGEND_CLASS_HERO, JOB_RANGER_HERO )
	SetShopBuyFactor( 1.5 )
	SetTroupeExpUpEvent( 8, 1.2 )
	SetCheerExpFactor( 1.2 )

	SetLevelUpGift( 105, "all", "II_SYS_SYS_SCR_BXKNIGHT_105", 1, 2, LEGEND_CLASS_NORMAL, JOB_KNIGHT )
	SetLevelUpGift( 105, "all", "II_SYS_SYS_SCR_BXBLADE_105", 1, 2, LEGEND_CLASS_NORMAL, JOB_BLADE )
	SetLevelUpGift( 105, "all", "II_SYS_SYS_SCR_BXRINGMASTER_105", 1, 2, LEGEND_CLASS_NORMAL, JOB_RINGMASTER )
	SetLevelUpGift( 105, "all", "II_SYS_SYS_SCR_BXBILLPOSTER_105", 1, 2, LEGEND_CLASS_NORMAL, JOB_BILLPOSTER )
	SetLevelUpGift( 105, "all", "II_SYS_SYS_SCR_BXELEMENTOR_105", 1, 2, LEGEND_CLASS_NORMAL, JOB_ELEMENTOR )
	SetLevelUpGift( 105, "all", "II_SYS_SYS_SCR_BXPSYCHIKEEPER_105", 1, 2, LEGEND_CLASS_NORMAL, JOB_PSYCHIKEEPER )
	SetLevelUpGift( 105, "all", "II_SYS_SYS_SCR_BXJESTER_105", 1, 2, LEGEND_CLASS_NORMAL, JOB_JESTER )
	SetLevelUpGift( 105, "all", "II_SYS_SYS_SCR_BXRANGER_105", 1, 2, LEGEND_CLASS_NORMAL, JOB_RANGER )
--}

...
public:
	...
	bool	CheckItem( vector<T_ADDITEM_INFO> & vecAddItemInfo );
	bool	IsEnoughEmptySpace( vector<T_ADDITEM_INFO> & vecAddItemInfo );
...
template<class T> bool CItemContainer<T>::CheckItem( vector<T_ADDITEM_INFO> & vecAddItemInfo )
{
...
template<class T> bool CItemContainer<T>::IsEnoughEmptySpace( vector<T_ADDITEM_INFO> & vecAddItemInfo )
{
	if( m_nContainerType == CONTAINER_TYPE_INVENTORY )
	{

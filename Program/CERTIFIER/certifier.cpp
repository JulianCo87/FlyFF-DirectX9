...
extern	string	g_strWebCertURL_GPotato;
extern	string	g_strWebCertURL_NotGPotato;
...
//		FLTRACE_LOG( PROGRAM_NAME, _T( "EnableConnectionPooling" ) );
	...
	if( FALSE == g_dpAccountClient.ConnectToServer( lpConnection, PN_ACCOUNTSRVR_0, FLStreamProtocol::GetInstance() ) )
	{

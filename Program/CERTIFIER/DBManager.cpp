...
extern string		g_strWebCertURL_NotGPotato;	//	일본 웹 인증 관련
extern string		g_strWebCertURL_GPotato;	//	일본 웹 인증 관련
...
BOOL CDbManager::CreateDbWorkers()
{
	...
	for( int i = 0; i < DEFAULT_DB_WORKER_THREAD_NUM; i++ )
	{
		...
		//{
		//	hThread	= chBEGINTHREADEX( NULL, 0, PhilippinesAuthWorker, (LPVOID)i, 0, NULL );
	//	}
		else
		{

...
// 	{
// 		FLTRACE_LOG( PROGRAM_NAME, _T( "LoadAddrPmttd false" ) );
// 	}	
	...
	if( FALSE == g_dpSrvr.StartServer( g_szCertifierBindIP, PN_ACCOUNTSRVR_0, FLStreamProtocol::GetInstance() )
		|| FALSE == g_dpDbSrvr.StartServer( g_szDatabaseBindIP, PN_ACCOUNTSRVR_1, FLStreamProtocol::GetInstance() )
		|| FALSE == CDPAdbill::GetInstance()->StartServer( g_szAdbillBindIP, PN_ADBILL, FLAdbillProtocol::GetInstance() )
		 )
	{
	...
	if( g_xASDBManager->AllOff() == false )
		return FALSE;

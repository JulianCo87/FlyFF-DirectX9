...
private:
	bool	LoadEquipInfo( CQuery* pQuery, DWORD dwPlayerId, DWORD dwMaxPartsSize, vector< EQUIP_INFO > & vecEquipInfo );
...
#ifdef __PROFESSION
	static void SaveProfession(CQuery* qry, u_long uidPlayer, int nLevel, int nExp, char* szQuery, size_t cchQuery);
	static bool LoadProfession(CMover* pMover, CQuery* qry);
#endif

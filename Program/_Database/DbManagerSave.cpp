...
#ifdef __PROFESSION
void CDbManager::SaveProfession(CQuery* qry, u_long uidPlayer, int nLevel, int nExp, char* szQuery, size_t cchQuery)
{
	FLSPrintf(szQuery, cchQuery, "uspProfession @query = 'S1', @idPlayer = '%07d', @nProfessionLevel = '%d', @nProfessionExp = '%d'",
		uidPlayer, nLevel, nExp);

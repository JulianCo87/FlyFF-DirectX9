...
{
	for( vector< TeleportationIconInfo* >::iterator Iterator = m_vecTeleportationPositionRect_User.begin(); Iterator != m_vecTeleportationPositionRect_User.end(); ++Iterator )
	{

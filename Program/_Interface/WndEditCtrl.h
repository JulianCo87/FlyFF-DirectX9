...
#define EN_DOWN				0x0605 // WndEdit에서만 사용하는 추가된 Notify
...
public:
	...
	BOOL	Create(HWND hwnd,DWORD dwStyle,const RECT& rect,CWndBase* pParentWnd,UINT nID, int nFontColorR, int nFontColorG, int nFontColorB );
	...
	void		SetTextSelectBlock(DWORD dwBegin,DWORD dwEnd);
	void  SetBeginBlock(DWORD dwBegin) {  }
	void  SetEndBlock(DWORD dwEnd) {  }
	...
	// added by gmpbigsun( 20101104 )
	BOOL	GetEditNum( OUT int& val );		//get numeric of editbox
	BOOL	GetEditNum64( OUT __int64& val );
...
public:
	//gmpbigsun(20110714) : 부모의 텍스쳐가 지정이 안되어있을때는 프레임이 그려지지않는버그가있음 
	BOOL				m_bForceDrawFrame; // 어쨓든 강제로 그린다.
};
/////////////////////////////////////////////////////////////////////////////

...
#ifdef __PROFESSION
DECLAREAPPLET( AppMain_WndProfession, new CWndProfession );
#endif // __PROFESSION
...
#ifdef __APP_TELEPORTER
	AddAppletFunc(AppMain_WndTeleporter, APP_TELEPORTER, _T("WndTeleporter"), _T("Icon_Motion.dds"), GETTEXT(TID_MENU_WNDTELEPORT), pShortcutKey_UI->AppTeleporter);
#endif //__APP_TELEPORTER
...
#endif
#ifdef __PROFESSION
	AddAppletFunc(AppMain_WndProfession, APP_PROFESSION, _T("WndProfession"), _T("Icon_Applet.dds"), "Metiers", 0); //animations
#endif // __PROFESSION

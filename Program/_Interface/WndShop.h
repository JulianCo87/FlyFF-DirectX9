...
public:
	void SetVecCart(vector<PT_T_SHOPCART> vecCart){m_vecCart = vecCart;/*.push_back(ptCart);*/}
	vector<PT_T_SHOPCART> GetVecCart(){return m_vecCart;}
...
private:
	...
	CRect		m_rectHittest;
	vector<PT_T_SHOPCART>	m_vecCart;
	CWndItemCtrlVendor m_wndItemCtrl[ MAX_VENDOR_INVENTORY_TAB ];

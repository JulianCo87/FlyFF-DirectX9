...
void CNeuzApp::HashMD5( char* szResult, size_t cchResult, LPCTSTR szPWD )
{
	...
	case LANG_USA:
		{
/*	TODO : 웹인증으로 변경되면서 클라암호화를 현재 하지않고 있으나 
인게임샵 호출 시 암호화한 패스워드 값을 사용하고 있어 현재 인게임샵 호출 시 마다 암호화하여 땜빵처리하고 있음.	*/
			szKey = "kikugalanet";		
		}
		break;
	case LANG_PHP:
	...
	//////////////////////////////////////////////////////////////////////////
	// 해외 16차 사내 테스트 서버 접속일 경우 키값 통일..-_-
	if( _strcmpi( g_xFlyffConfig->GetCertifierAddr(), "172.16.100.17" ) == 0 )
	{
		szKey = "tksogodhl";	// 사내해외
	}
	//////////////////////////////////////////////////////////////////////////

	//////////////////////////////////////////////////////////////////////////
	// 해외 17차 사내 테스트 서버 접속일 경우 키값 통일..-_-

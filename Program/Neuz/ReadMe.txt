...
{
	m_nRealItem[ 0 ] = ITEM_INDEX( 6307, II_SYS_SYS_EVE_0504M1NOTEBOOK );
	m_nRealItem[ 1 ] = ITEM_INDEX( 6308, II_SYS_SYS_EVE_0504M2DCAMARA );
	m_nRealItem[ 2 ] = ITEM_INDEX( 6309, II_SYS_SYS_EVE_0504M3AIRSHIP );   
	m_nRealItem[ 3 ] = ITEM_INDEX( 6310, II_SYS_SYS_EVE_0504M4USBFANLIGHT );
	m_nRealItem[ 4 ] = ITEM_INDEX( 6311, II_SYS_SYS_EVE_0504M5BALLOON );
	m_nRealItem[ 5 ] = ITEM_INDEX( 6312, II_SYS_SYS_EVE_0504M6GIFTTICKET );
	m_nRealItem[ 6 ] = ITEM_INDEX( 6313, II_SYS_SYS_EVE_0504M7MOVIETICKET );
	m_nRealItem[ 7 ] = ITEM_INDEX( 6314, II_SYS_SYS_EVE_0504M8OST );

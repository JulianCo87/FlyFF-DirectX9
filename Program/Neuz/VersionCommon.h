...
#define		__SFX_OPT					// 이펙트(파티클) 최적화 관련 TODO 클라이언트, PatchClient만
#define		__CPU_UTILDOWN_060502		// CPU 사용률 감소작업 TODO 요건 왜 내부만?, //gmpbigsun(20110104) 이제 외부도 같이써야함

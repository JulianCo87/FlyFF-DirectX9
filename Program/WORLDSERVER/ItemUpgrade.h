...
private:
	...
	map<int, int>	m_mapBarunaSuitProb;
#endif
...
#ifdef COSTUME_UPGRADE_ENHANCEMENT_GEM
	map<int, int>	m_mapCostumeEnchant;
#endif
	map<int, __ATTRIBUTE_ENCHANT> m_mapAttributeEnchant;

#ifdef BARUNA_UPGRADE_SMELT_SAFETY
	map<int, __BARUNA_NPC_LEVEL> m_mapBarunaNPCLevel;
	map<int, __BARUNA_ENCHANT> m_mapBarunaWeaponEnchant;
	map<int, __BARUNA_ENCHANT> m_mapBarunaArmorEnchant;
#endif

...
//      
// 	public:
// 		typedef				vector< int/*Lang*/>		LangVec;
// 		typedef				vector< FLPeriod >			PeriodVec;
// 		typedef				vector< DropItem_Data >		DropItemVec;
// 
// 		int					m_nLevelMin;
// 		int					m_nLevelMax;
// 
...
private:
// 	typedef					map< DWORD/* dwEventID */, FLEventSet >		EventSetMap;
// 

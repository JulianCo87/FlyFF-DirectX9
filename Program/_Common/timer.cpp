...
//	//nMin    = ( int )( nSec / 60 ); // 60초로 나눈다.
//	//m_nMin  = ( int )( nSec % 60 ); // 60초로 나눈다.
//	//nHour   = ( int )( nMin / 24 ); // 24시간으로 나눈다.
//	//m_nHour = ( int )( nMin % 24 ); // 24시간으로 나눈다.
//	//nDay    = ( int )( nHour / 30 ); // 30일로 나눈다.
//	//m_nDay  = ( int )( nHour % 30 ); // 30일로나눈다.
//
//	//m_nHour++; // 1 based
//	//m_nDay++; // 1 based
//	////m_nHour = 19;	

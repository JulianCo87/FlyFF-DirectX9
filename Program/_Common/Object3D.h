...
public:
	...
	D3DXVECTOR3		m_vForce3, m_vForce4;			// 추가지점 시작점,끝점		//sun: 9차 제련관련 (추가 검광 기능)
...
//	int		Find( int nID );
	...
	{ 
		...
		{
			FLERROR_LOG( PROGRAM_NAME, _T( "lv=%d, %s" ), nLevel, m_szFileName );
			nLevel = 0;
		}
...
//sun: 13, 하우징 시스템
	...
	BOOL	TriIntersect_BBOX( D3DXMATRIX mWorld, CObj* pTargetObj, D3DXMATRIX mTargetWorld);		//gmpbigsun(20101021 )

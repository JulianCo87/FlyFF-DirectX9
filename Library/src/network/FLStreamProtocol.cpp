...
#include "../../include/network/FLStreamProtocol.h"
...
FLStreamProtocol*	FLStreamProtocol::GetInstance()
{
	static FLStreamProtocol xNormalProtocol;
	return &xNormalProtocol;
}

FLStreamProtocol::FLStreamProtocol()
{
}
...
bool	FLStreamProtocol::FetchStream( CBuffer** pBuffer, CBufferQueue* pQueue )
{
	u_long nRemnant = 0;
...
bool	FLStreamProtocol::PushSystemStream( CBuffer* pBuffer, LPBYTE lpData, u_long uDataSize )
{
...
bool	FLStreamProtocol::SendStream( CBufferQueue* pQueue, LPBYTE lpData, u_long uDataSize )
{
	//	header
	T_NORMAL_HEADER tHeader;
	tHeader.dwSize = uDataSize;
...
FLStreamProtocol*	FLStreamProtocol::Clone()
{
	return this;
}

void	FLStreamProtocol::Release()
{
}

void	FLStreamProtocol::GetData( void* pStream, void** pData, u_long* nDataSize )
{
...
void*	FLStreamProtocol::GetNextStream( void* pStream )
{
	T_NORMAL_HEADER* pHeader = reinterpret_cast< T_NORMAL_HEADER* >( pStream );
...
#include "../../include/crypto/FLCRC32.h"
#include "../../include/crypto/FLXOR.h"

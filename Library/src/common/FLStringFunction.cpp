...
#include "../../include/common/FLStringFunction.h"
...
{
	std::string::const_iterator iter = std::find_if( strString.begin(), strString.end(), std::not1( std::ptr_fun( ::isspace ) ) );
	return std::string( iter, strString.end() );
}

std::string	FLTrimRight( const std::string& strString )
{
	std::string::const_reverse_iterator iter = std::find_if( strString.rbegin(), strString.rend(), std::not1( std::ptr_fun( ::isspace ) ) );
	return std::string( strString.begin(), iter.base() );
}
...
{
	std::wstring::const_iterator iter = std::find_if( strString.begin(), strString.end(), std::not1( std::ptr_fun( ::iswspace ) ) );
	return std::wstring( iter, strString.end() );
}

std::wstring	FLTrimRight( const std::wstring& strString )
{
	std::wstring::const_reverse_iterator iter = std::find_if( strString.rbegin(), strString.rend(), std::not1( std::ptr_fun( ::iswspace ) ) );
	return std::wstring( strString.begin(), iter.base() );
}
